        ...
        <div>
            <Grid container className="main" id="about">
                ...
                <Grid item xs={12} sm={12} md={6} lg={6} >
                    <div className="main__content" >
                        <h2>
                    PEC Quora is a Multifunctinal website for Pondicherry Engineering College. <br />
                    Attempting to: <br />
                    1) Bridge the gap between students & passouts. <br />
                    2) Help students with carrer guidance, solving their problems. <br />
                            <br />
                    ...
                    Here is the code, star the repo ♥:
                        ...
                        <br />
                        <a style={{ textDecoration: 'none', color: 'black' }} href="https://github.com/akshay1027/pecquora" target="_blank" rel="noreferrer">
            ...
            <Grid className="row" item xs={12} sm={12} md={12} lg={12}>
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Akshay R R</h4>
                        <a style={{ textDecoration: 'none', color: 'black' }} href="https://github.com/akshay1027/" target="_blank" rel="noreferrer">
                            <GitHubIcon className="developer-icon"/>
                        </a>
                        <a style={{ textDecoration: 'none', color: 'black' }} href="https://www.linkedin.com/in/akshayrr1027/" target="_blank" rel="noreferrer">
                            <LinkedInIcon className="developer-icon"/>
                        </a>
                    </div>
                    <div class="card-body" id="developer">
                        <p>
                            I am a second year student at PTU (formerly PEC), Pondicherry, pursuing my Bachelors in ECE.
                            <br />
                            <br />
