        ...
        <Grid container className="main" id="about">
            ...
            <div className="main__content" >
                    ...
                    Here is the code, star the repo ♥: 
                        ...
                        <a style={{textDecoration: "none", color: "black"}} href="https://github.com/akshay1027/pecquora" target="_blank">
            ...
            <div class="card-header">
                ...
                <div className="main__content">
                    ...
                    <div class="card-header">
                        <h4>Akshay R R</h4>
                        <a style={{textDecoration: "none", color: "black"}} href="https://github.com/akshay1027/" target="_blank">
                        <GitHubIcon className="developer-icon"/>
                        </a>
                        <a style={{textDecoration: "none", color: "black"}} href="https://www.linkedin.com/in/akshayrr1027/" target="_blank">
